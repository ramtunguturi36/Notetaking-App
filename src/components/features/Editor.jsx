  ...
  return (
    <section className="editor-view">
      ...
      <div className="floating-toolbar">
        ...
        <button onClick={() => applyCommand("formatBlock", "h2")}>
          Heading
        </button>
      ...
      {showSlashMenu && (
        <div className="slash-menu">
          <button
            onClick={() =>
              insertHtmlAtCursor(
                "<table><tr><th>Col A</th><th>Col B</th></tr><tr><td>1</td><td>2</td></tr></table><p></p>",
              )
            }
          >
            Insert Table
          ...
          <button
            onClick={() =>
              insertHtmlAtCursor("<ul><li>New task</li></ul><p></p>")
            }
          >
            Insert Task List
          </button>
